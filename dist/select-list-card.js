      ...
      <div class="card-config">
        <div class="values">
          ...
          <div class="row">
            ...
            <span class="switch-label">${Re("editor.show_toggle")}</span>
          </div>
          <div class="row">
            <ha-switch
            ...
            <span class="switch-label">${Re("editor.scroll_to_selected")}</span>
          </div>
          <div class="row">
            <ha-switch
