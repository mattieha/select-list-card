...
customElements.define('action-handler-select-list-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-select-list-card')) {
    return body.querySelector('action-handler-select-list-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-select-list-card');
